<div class="col-md-9">
    <?php if(!isset($user['followers']) || sizeof($user['followers']) == 0):?>
    <div class="panel panel-default">
            <div class="panel-heading"><?php echo $this->lang->line('user_followers');?>
            ...
            <div class="panel-content">
                <div class="alert alert-info" style="font-size:13px;margin-bottom:0;border-radius:0;-moz-border-radius:0;-webkit-border-radius:0;"><?php echo $this->lang->line('user_no_followers');?></div>
            </div>
    </div>
    <?php else:?>
    <div class="panel panel-primary">
        <div class="panel-heading"><?php echo $this->lang->line('user_followers');?> (<?php echo $user['followers_number'];?>)
            <a href="<?php echo $this->vinc_auth->userURL($user['login']);?>" class="btn btn-xs btn-default pull-right">
                <i class="fa fa-sign-out"></i> <?php echo $this->lang->line('user_back');?>
            </a>
        </div>
    ...
    <div class="follow-user-block">
        ...
        <?php if($user['followers_number'] > $this->config->item('followings_number')):?>
            ...
            <script type="text/javascript">
                $(function() {
                    followersOffset = <?php echo $this->config->item('followings_number');?>;
                    $('body').on('click', '#follow-user-load', function(e) {
                        e.preventDefault();
                        UserProfile.loadFollowers(<?php echo $user['id'];?>, followersOffset);
                    });
                });
            </script>
        <?php endif;?>
