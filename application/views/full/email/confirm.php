                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td style="color: #153643; font-family: Arial, sans-serif; font-size: 24px;">
                                        <b>中国的 ipsum dolor sit amet!</b>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding: 20px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
                                        Привет, <?php echo $this->registry->get('username');?>. Ты хочешь подтвердить свой email [<?php echo $this->registry->get('email');?>]?
                                        Перейди по <a href="<?php echo site_url('auth/confirm/' . $this->registry->get('confirm'));?>">ссылке</a>
